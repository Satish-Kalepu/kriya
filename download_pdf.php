...
if( $_GET['event'] == 'download_pdf' ){
	...
	<td class='hcol3' align='left' rowspan=\"2\" style=\"font-weight:bold;\" >Competition</td>
	...
	foreach ($config_categories as $key => $value) 
	{
		$key = (int)$key;
		$html .="<tr>
		<td class=\"col_\" align='center'>".$value['sno']."</td>
	...
	$mpdf->Output('school_'.$_GET['record_id'].".pdf",'D');
	exit;
