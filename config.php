...
"102"=>array(
	...
	"english"=> "Classical Dance - Group", 
 	"details"=>"Minimum 5 in group. CD/Pendrive/Orchestra Allowed", 
	"enabled"=> array( 1, 1, 1), 
...
"106"=> array( 
	...
	"details"=>"Any skill can be presented", 
	 "enabled"=> array( 0, 1, 1), 
	 "max"=> array( 0, [1,2], [1,2] ),
	 ), 
"107"=> array( 
	...
	"details"=>"Topics: Jr: Chandrayan or Rivers, Sr: WomenRights or G20", 
	 "enabled"=> array( 0, 1, 1), 
	 "max"=> array( 0, [1,2], [1,2] ),
	 ), 
"108"=> array( 
...
"123"=> array(
	...
	"name"=> "Burrakatha", 
	"english"=> "Burrakatha", 
	"details"=>"Choose a topic suitable for age group. Minimum 10 minites", 
	"enabled"=> array( 1, 1, 1), 
...
"127"=> array(
	 "sno"=> "127",
	 "name"=>"Clay Modeling - Solo",
	 "english"=> "Clay Modeling - Solo", 
...
"128"=> array(
	 "sno"=> "128",
	 "name"=>"Clay Modeling - Group",
	 "english"=> "Clay Modeling - Group", 
	 "details"=>"Clay will be provided. Topic will be announced on the spot",
	"enabled"=> array( 0, 0, 1), 
	"max"=> array( 0, 0, [3,10] ),
	)
